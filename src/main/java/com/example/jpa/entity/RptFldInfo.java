...
public class RptFldInfo implements Serializable {
	...
	@Id
	@Column(name="RPT_FLD_ID", unique=true, nullable=false)
	...
	@Column(name="RPT_FLD_NM", nullable=false, length=200)
	private String rptFldNm;

	@Temporal(TemporalType.DATE)
	@Column(name="RPT_FLD_START_DT", nullable=false)
...
/*
	...
	@ManyToOne
	@JoinColumns({
		@JoinColumn(name="REFNC_CD", referencedColumnName="REFNC_TYP", nullable=false),
		@JoinColumn(name="REFNC_TYP", referencedColumnName="REFNC_CD", nullable=false)
		})
